...
function start() {
  ...
  for (i = 0; i < data.length; i++) {
    ...
    document.getElementById("company_list")
      .appendChild(opt_company);
    document.getElementById("lang_list")
      .appendChild(opt_lang);
    document.getElementById("exp_list")
      .appendChild(opt_exp);
    document.getElementById("city_list")
      .appendChild(opt_city);
  }
  // Обработка нажатий на кнопки	
  document.getElementById("search_button")
    .addEventListener("click", search_start);
  document.getElementById("filtres_apply_button")
    .addEventListener("click", apply_filters);
  document.getElementById("mobile_filtres_apply_button")
    .addEventListener("click", apply_filters);
}

function search_start() {
  let req = document.getElementById("search_input")
    .value,
    arr = [],
    res = [],
  ...
  document.getElementById("to_start_button")
    .addEventListener("click", start);
}

function apply_filters() {
  let f_comp = document.getElementById("f_comp")
    .value || document.getElementById("mobile_f_comp")
    .value,
    f_lang = document.getElementById("f_lang")
    .value || document.getElementById("mobile_f_lang")
    .value,
    f_exp = document.getElementById("f_exp")
    .value || document.getElementById("mobile_f_exp")
    .value,
    f_city = document.getElementById("f_city")
    .value || document.getElementById("mobile_f_city")
    .value,
    f_salary_min = document.getElementById("f_salary_min")
    .value || document.getElementById("mobile_f_salary_min")
    .value,
    f_salary_max = document.getElementById("f_salary_max")
    .value || document.getElementById("mobile_f_salary_max")
    .value,
    field = document.getElementById("main_content"),
    comp = true,
    lang = true,
